...
### Medium Priority
4. Large document handling → Better UX
5. Vague query handling → Use context better
6. API key validation → Prevent crashes

### Low Priority
7. Multilingual support → Already works
8. Cross-doc comparison → Nice to have
9. Batch uploads → Future enhancement
